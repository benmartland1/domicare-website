...
export function TableOfContents({ headings, variant = "dark" }: Props) {
  ...
  const labelClass = isPaper
    ...
    : "eyebrow mb-4 text-[color:var(--color-slate)]";
  const activeClass = isPaper
    ? "border-[color:var(--color-ocean)] text-[color:var(--color-ink)]"
    : "border-[color:var(--color-sky)] text-[color:var(--color-sky)]";
  const inactiveClass = isPaper
    ...
    : "border-[color:var(--color-line)] text-[color:var(--color-slate-2)] hover:border-[color:var(--color-line-strong)] hover:text-[color:var(--color-navy)]";
