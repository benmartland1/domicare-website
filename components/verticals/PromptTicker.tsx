...
const DEFAULT_PROMPTS: TickerPrompt[] = [
  { q: "best dementia care home near Preston", engine: "ChatGPT" },
  { q: "how much does a nursing home cost per week UK", engine: "Gemini" },
  { q: "care homes in Harrogate with good CQC ratings", engine: "ChatGPT" },
  { q: "care home that takes respite for two weeks near me", engine: "Perplexity" },
];
...
export function PromptTicker({
  ...
  note = "a family is searching right now",
}: {
