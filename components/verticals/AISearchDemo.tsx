            ...
            <div className="mt-4 sm:mt-5">
              <div className="flex items-center gap-2 text-[12px] sm:text-[13px] text-[color:var(--color-ink-3)]">
                <span className="flex gap-1" aria-hidden>
                  {[0, 1, 2].map((i) => (
                    <span
                      key={i}
                      className="engine-pulse h-1.5 w-1.5 rounded-full bg-[color:var(--color-ocean)]"
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {SOURCES.map((s, i) => (
                  ...
                  >
                    <span className="h-1.5 w-1.5 rounded-full bg-[color:var(--color-sky-2)]" />
                    {s}
                  </span>
                ))}
              </div>
          ...
          {showAnswer ? (
            <div className="mt-4 sm:mt-5">
              <p className="text-[12.5px] leading-[1.45] text-[color:var(--color-ink-2)] sm:text-[16px] sm:leading-relaxed">
                ...
                {phase === "answering" ? (
                  <span className="caret ml-0.5 inline-block h-[1em] w-[2px] translate-y-[0.12em] bg-[color:var(--color-ocean)]" />
                ) : null}
              </p>
                ...
                {RESULTS.slice(0, rows).map((r, i) => (
                  <div
                    ...
                    className={`row-in flex items-center gap-2.5 rounded-xl border px-2.5 py-1.5 sm:gap-3 sm:px-3.5 sm:py-3 ${
                      ...
                      r.you
                        ? "border-[color:var(--color-ocean)]/35 bg-[color:var(--color-ocean)]/[0.06]"
                  ...
                  >
                    <span
                      className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[10px] font-bold sm:h-6 sm:w-6 sm:text-[11px] ${
                        r.you
                          ? "bg-[color:var(--color-ocean)] text-white"
                    ...
                    {r.you ? (
                      <span className="ml-auto shrink-0 rounded-full bg-[color:var(--color-ocean)] px-2 py-1 text-[10px] font-bold uppercase tracking-[0.1em] text-white">
                        Cited
                      </span>
                    ) : null}
                  </div>
