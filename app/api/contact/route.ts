...
// Note: `from` is internal-only for this route — the visitor sees `replyTo`.
  const to = process.env.CONTACT_TO_EMAIL ?? "hi@domisearch.com";
  ...
  const html = `
    <div style="font-family: -apple-system, system-ui, sans-serif; background: #090909; color: #dddfde; padding: 32px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr><td style="padding: 8px 0; color: #aaa;">Email</td><td><a style="color:#14c2b0" href="mailto:${escape(email)}">${escape(email)}</a></td></tr>
